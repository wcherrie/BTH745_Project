...
var filter = function() {
	console.log("filter")
	$(".sticky-top").find(".active").removeClass("active")
	console.log("sss",$(".sticky-top").find("[href='" + document.location.hash + "']"))
	$(".sticky-top").find("[href='" + document.location.hash + "']").addClass("active")
}

routie('premium', function(name) {
	filter()
	$(".free").hide()
	$(".premium").show()
});
...
routie('premium/:name', function(name) {
	filter()
	$(".free").hide()
	$(".premium").show()
});

routie('free', function(name) {
	filter()
	$(".free").show()
	$(".premium").hide()
});
